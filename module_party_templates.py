...
#SB : changes to icons
  ("black_khergit_raiders","Black Khergit Raiders",icon.khergit_horseman_b|carries_goods(2),0,fac.black_khergits,bandit_personality,[(trp.black_khergit_horseman,5,10)]),
  ("steppe_bandits","Steppe Bandits",icon.khergit_horseman_b|carries_goods(2),0,fac.outlaws,bandit_personality,[(trp.steppe_bandit,4,100)]),
  ("taiga_bandits","Tundra Bandits",icon.axeman|carries_goods(2),0,fac.outlaws,bandit_personality,[(trp.taiga_bandit,4,100)]),
  ("desert_bandits","Desert Bandits",icon.khergit|carries_goods(2),0,fac.outlaws,bandit_personality,[(trp.desert_bandit,4,100)]),
  ("forest_bandits","Forest Bandits",icon.axeman|carries_goods(2),0,fac.forest_bandits,bandit_personality,[(trp.forest_bandit,4,100)]),
  ("mountain_bandits","Mountain Bandits",icon.axeman|carries_goods(2),0,fac.mountain_bandits,bandit_personality,[(trp.mountain_bandit,4,100)]),
  ("sea_raiders","Sea Raiders",icon.axeman|carries_goods(2),0,fac.outlaws,bandit_personality,[(trp.sea_raider,5,100)]),

  ("deserters","Deserters",icon.vaegir_knight|carries_goods(3),0,fac.deserters,bandit_personality,[]),
    
  #SB : fix icon
  ("merchant_caravan","Merchant Caravan",icon.mule|carries_goods(20)|pf_auto_remove_in_town|pf_quest_party,0,fac.commoners,escorted_merchant_personality,[(trp.caravan_master,1,1),(trp.caravan_guard,5,25)]),
  ...
  ("spy_partners", "Unremarkable Travellers", icon.player_horseman|carries_goods(10)|pf_default_behavior|pf_quest_party,0,fac.neutral,merchant_personality,[(trp.spy_partner,1,1),(trp.caravan_guard,5,11)]),
  ...
  ("spy", "Ordinary Townsman", icon.player_horseman|carries_goods(4)|pf_default_behavior|pf_quest_party,0,fac.neutral,merchant_personality,[(trp.spy,1,1)]),
...
##  ("conspirator_leader", "Conspirator Leader", icon.gray_knight|carries_goods(8)|pf_default_behavior|pf_quest_party,0,fac.neutral,merchant_personality,[(trp.conspirator_leader,1,1)]),
  ("peasant_rebels", "Peasant Rebels", icon.peasant,0,fac.peasant_rebels,bandit_personality,[(trp.farmer,50,400)]),
  ("landless_knights", "Landless Knights", icon.gray_knight,0,fac.outlaws,bandit_personality,[(trp.robber_knight,1,7)]),
...
#  ("war_party", "War Party",icon.gray_knight|carries_goods(3),0,fac.commoners,soldier_personality,[]),
  ...
  ("messenger_party","Messenger",icon.flagbearer_b|pf_show_faction,0,fac.commoners,merchant_personality,[]),
  ...
  ("default_prisoners","Default Prisoners",icon.vaegir_knight,0,fac.commoners,0,[(trp.bandit,5,10,pmf_is_prisoner)]),
...
# Caravans
  ...
  ("center_reinforcements","Reinforcements", icon.axeman|pf_show_faction|carries_goods(4),0,fac.commoners,escorted_merchant_personality,[]),
...
##  ("kingdom_5_reinforcements_c", "kingdom_5_reinforcements_c", 0, 0, fac.commoners, 0, [(trp.rhodok_sergeant,3,7),(trp.rhodok_veteran_spearman,2,5),(trp.rhodok_veteran_crossbowman,2,5)]),
  ...
  ("leaded_looters","Band of robbers",icon.axeman|carries_goods(8)|pf_quest_party,0,fac.neutral,bandit_personality,[(trp.looter_leader,1,1),(trp.looter,3,3)]),
   ...
   ##diplomacy begin
  ("dplmc_spouse","Your spouse",icon.woman_b|pf_civilian|pf_show_faction,0,fac.neutral,merchant_personality,[]),

  ("dplmc_gift_caravan","Your Caravan",icon.mule|carries_goods(25)|pf_show_faction,0,fac.commoners,escorted_merchant_personality,[(trp.caravan_master,1,1),(trp.caravan_guard,5,25)]),
#recruiter kit begin
   ("dplmc_recruiter","Recruiter",icon.flagbearer_b|pf_show_faction,0,fac.neutral,merchant_personality,[(trp.dplmc_recruiter,1,1)]),
#recruiter kit end
   ##diplomacy end

#new pts
  ("roving_knights","Band of Knights",icon.gray_knight,0,fac.commoners,soldier_personality,[(trp.common_knight,1,30)]),
  ("robber_knights","Robber Knights",icon.gray_knight,0,fac.robber_knights,bandit_personality,[(trp.robber_knight,1,30)]),
  ("merc_camp_geroia_troops", "{!}Geroian Mercs", 0, 0, fac.commoners, 0, [(trp.geroia_swordsman,5,10),(trp.geroia_pikeman,4,8),(trp.geroia_pavisier,4,8),(trp.geroia_sergeant,1,2)]),
  ("merc_camp_balion_troops", "{!}Balion Mercs", 0, 0, fac.commoners, 0, [(trp.balion_infantry,5,12),(trp.balion_longbowman,4,10),(trp.balion_knight,1,6)]),
  ("merc_camp_jumne_troops", "{!}Jumne Mercs", 0, 0, fac.commoners, 0, [(trp.jumne_raider,5,12),(trp.jumne_skirmisher,4,10),(trp.jumne_huscarl,1,6)]),
  ("merc_camp_zendar_troops", "{!}Zendar Mercs", 0, 0, fac.commoners, 0, [(trp.manhunter,5,12),(trp.slave_hunter,4,10),(trp.slave_crusher,1,6)]),
# Merc Camp End
