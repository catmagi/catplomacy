...
["arena_master", 0, amf_client_prediction,
   [3.0, "arena_master_stand", 0, 79, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
 ],

 ### Mark7 (meldo) arena Animations END
 #######################################
