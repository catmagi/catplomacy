...
#  Malabadi_Castle
  ...
  ("castle_6","Tilbaut_Castle",icon.castle_a|pf_castle, no_menu, pt.none, fac.neutral,0,ai_bhvr_hold,0,(37.6, 17.1),[],55),
  ("castle_7","Sungetche_Castle",icon.castle_snow_a|pf_castle, no_menu, pt.none, fac.neutral,0,ai_bhvr_hold,0,(109.5, 41.5),[],45),
  ("castle_8","Jeirbe_Castle",icon.castle_a|pf_castle, no_menu, pt.none, fac.neutral,0,ai_bhvr_hold,0,(35.2, 89),[],30),
  ("castle_9","Jamiche_Castle",icon.castle_a|pf_castle, no_menu, pt.none, fac.neutral,0,ai_bhvr_hold,0,(-7.5, -82.6),[],100),
  ("castle_10","Alburq_Castle",icon.castle_a|pf_castle, no_menu, pt.none, fac.neutral,0,ai_bhvr_hold,0,(24.2, 96.85),[],110),
  ("castle_11","Curin_Castle",icon.castle_a|pf_castle, no_menu, pt.none, fac.neutral,0,ai_bhvr_hold,0,(-27.50, 83.46),[],75),
  ("castle_12","Chalbek_Castle",icon.castle_b|pf_castle, no_menu, pt.none, fac.neutral,0,ai_bhvr_hold,0,(-84.75, 105.5),[],95),
  ("castle_13","Kelredan_Castle",icon.castle_a|pf_castle, no_menu, pt.none, fac.neutral,0,ai_bhvr_hold,0,(-10.6, 17.6),[],115),
  ("castle_14","Maras_Castle",icon.castle_c|pf_castle, no_menu, pt.none, fac.neutral,0,ai_bhvr_hold,0,(-122.4, -18.1),[],90),
  ("castle_15","Ergellon_Castle",icon.castle_a|pf_castle, no_menu, pt.none, fac.neutral,0,ai_bhvr_hold,0,(-52.5, -28),[],235),
  ("castle_16","Almerra_Castle",icon.castle_c|pf_castle, no_menu, pt.none, fac.neutral,0,ai_bhvr_hold,0,(-10.6, -65.6),[],45),
  ("castle_17","Distar_Castle",icon.castle_a|pf_castle, no_menu, pt.none, fac.neutral,0,ai_bhvr_hold,0,(140.3, -10.8),[],15),
  ("castle_18","Ismirala_Castle",icon.castle_snow_a|pf_castle, no_menu, pt.none, fac.neutral,0,ai_bhvr_hold,0,(14.4, 70.1),[],300),
  ("castle_19","Yruma_Castle",icon.castle_snow_a|pf_castle, no_menu, pt.none, fac.neutral,0,ai_bhvr_hold,0,(69.5, 55.6),[],280),
  ("castle_20","Derchios_Castle",icon.castle_a|pf_castle, no_menu, pt.none, fac.neutral,0,ai_bhvr_hold,0,(16, 11.5),[],260),
  ("castle_21","Ibdeles_Castle",icon.castle_a|pf_castle, no_menu, pt.none, fac.neutral,0,ai_bhvr_hold,0,(-73, -89.5),[],260),
  ("castle_22","Unuzdaq_Castle",icon.castle_a|pf_castle, no_menu, pt.none, fac.neutral,0,ai_bhvr_hold,0,(33, -64),[],260),
  ("castle_23","Tevarin_Castle",icon.castle_a|pf_castle, no_menu, pt.none, fac.neutral,0,ai_bhvr_hold,0,(-124.8, 44.3),[],80),
  ("castle_24","Reindi_Castle",icon.castle_a|pf_castle, no_menu, pt.none, fac.neutral,0,ai_bhvr_hold,0,(24.9, -35.6),[],260),
  ("castle_25","Ryibelet_Castle",icon.castle_a|pf_castle, no_menu, pt.none, fac.neutral,0,ai_bhvr_hold,0,(-57, 30.6),[],260),
  ...
  ("castle_32","Knudarr_Castle",icon.castle_a|pf_castle, no_menu, pt.none, fac.neutral,0,ai_bhvr_hold,0,(2, 30.1),[],260),
  ("castle_33","Etrosq_Castle",icon.castle_a|pf_castle, no_menu, pt.none, fac.neutral,0,ai_bhvr_hold,0,(-101.4, -32.1),[],80),
  ("castle_34","Hrus_Castle",icon.castle_a|pf_castle, no_menu, pt.none, fac.neutral,0,ai_bhvr_hold,0,(-72.5, 78.6),[],260),
  ("castle_35","Haringoth_Castle",icon.castle_a|pf_castle, no_menu, pt.none, fac.neutral,0,ai_bhvr_hold,0,(-110, 0),[],260),
  ("castle_36","Jelbegi_Castle",icon.castle_a|pf_castle, no_menu, pt.none, fac.neutral,0,ai_bhvr_hold,0,(-47.3, 53.2),[],260),
  ("castle_37","Dramug_Castle",icon.castle_c|pf_castle, no_menu, pt.none, fac.neutral,0,ai_bhvr_hold,0,(55.3, 23),[],260),
  ...
  ("castle_44","Durrin_Castle",icon.castle_d|pf_castle, no_menu, pt.none, fac.neutral,0,ai_bhvr_hold,0,(128, -87),[],260),
  ("castle_45","Caraf_Castle",icon.castle_d|pf_castle, no_menu, pt.none, fac.neutral,0,ai_bhvr_hold,0,(30.6, -110.6),[],260),
...
# Tuavus   Pamir   vezona 
  ...
  ("village_4", "Nomar",  icon.village_a|pf_village, no_menu, pt.none, fac.neutral,0,ai_bhvr_hold,0,(-36.6, -13.2),[], 130),
  ("village_5", "Kulum",  icon.village_a|pf_village, no_menu, pt.none, fac.neutral,0,ai_bhvr_hold,0,(-122.7, 106.3),[], 170),
  ("village_6", "Emirin",  icon.village_a|pf_village, no_menu, pt.none, fac.neutral,0,ai_bhvr_hold,0,(5.5, -2.5),[], 100),
  ("village_7", "Amere",  icon.village_a|pf_village, no_menu, pt.none, fac.neutral,0,ai_bhvr_hold,0,(39.3, -5.25),[], 110),
  ...
  ("village_14","Sumbuja",  icon.village_a|pf_village, no_menu, pt.none, fac.neutral,0,ai_bhvr_hold,0,(40,52),[], 130),
  ("village_15","Ryibelet",  icon.village_a|pf_village, no_menu, pt.none, fac.neutral,0,ai_bhvr_hold,0,(-49.3, 26.25),[], 170),
  ("village_16","Shapeshte",  icon.village_snow_a|pf_village, no_menu, pt.none, fac.neutral,0,ai_bhvr_hold,0,(74, 86.8),[], 170),
  ("village_17","Mazen",  icon.village_snow_a|pf_village, no_menu, pt.none, fac.neutral,0,ai_bhvr_hold,0,(44.7, 91.4),[], 35),
  ...
  ("village_24","Ruldi",  icon.village_a|pf_village, no_menu, pt.none, fac.neutral,0,ai_bhvr_hold,0,(-57.6, -73),[], 130),
  ("village_25","Dashbigha",  icon.village_a|pf_village, no_menu, pt.none, fac.neutral,0,ai_bhvr_hold,0,(125.2, -8),[], 170),
  ("village_26","Pagundur",  icon.village_a|pf_village, no_menu, pt.none, fac.neutral,0,ai_bhvr_hold,0,(-58.5, -30.8),[], 170),
  ...
  ("village_33","Ruluns",  icon.village_a|pf_village, no_menu, pt.none, fac.neutral,0,ai_bhvr_hold,0,(-59, 10.6),[], 120),
  ("village_34","Ehlerdah",  icon.village_a|pf_village, no_menu, pt.none, fac.neutral,0,ai_bhvr_hold,0,(34.15, -30),[], 130),
  ("village_35","Fearichen",  icon.village_a|pf_village, no_menu, pt.none, fac.neutral,0,ai_bhvr_hold,0,(2.14, 86.9),[], 170),
  ("village_36","Jayek",  icon.village_a|pf_village, no_menu, pt.none, fac.neutral,0,ai_bhvr_hold,0,(17.4, 100.7),[], 170),
  ("village_37","Ada_Kulun",  icon.village_a|pf_village, no_menu, pt.none, fac.neutral,0,ai_bhvr_hold,0,(164.4, 26),[], 170),
  ...
  ("village_44","Peshmi",  icon.village_a|pf_village, no_menu, pt.none, fac.neutral,0,ai_bhvr_hold,0,(51.8, -50),[], 130),
  ("village_45","Bulugur",  icon.village_a|pf_village, no_menu, pt.none, fac.neutral,0,ai_bhvr_hold,0,(151.5, -3),[], 170),
  ("village_46","Fedner",  icon.village_a|pf_village, no_menu, pt.none, fac.neutral,0,ai_bhvr_hold,0,(-82.4, -48.8),[], 170),
  ("village_47","Epeshe",  icon.village_a|pf_village, no_menu, pt.none, fac.neutral,0,ai_bhvr_hold,0,(-101.2, -53.7),[], 170),
  ...
  ("village_54","Chide",  icon.village_a|pf_village, no_menu, pt.none, fac.neutral,0,ai_bhvr_hold,0,(-19, 15.5),[], 130),
  ("village_55","Tadsamesh",  icon.village_a|pf_village, no_menu, pt.none, fac.neutral,0,ai_bhvr_hold,0,(37.3, 23.7),[], 170),
  ("village_56","Fenada",  icon.village_a|pf_village, no_menu, pt.none, fac.neutral,0,ai_bhvr_hold,0,(-5.55, 75.5),[], 170),
  ("village_57","Ushkuru",  icon.village_a|pf_village, no_menu, pt.none, fac.neutral,0,ai_bhvr_hold,0,(24.75, -7.7),[], 170),
  ...
  ("village_64","Serindiar",  icon.village_a|pf_village, no_menu, pt.none, fac.neutral,0,ai_bhvr_hold,0,(-41.5, -35.8),[], 100),
  ("village_65","Iyindah",  icon.village_a|pf_village, no_menu, pt.none, fac.neutral,0,ai_bhvr_hold,0,(-86.3, 12.4),[], 100),
  ("village_66","Fisdnar",  icon.village_a|pf_village, no_menu, pt.none, fac.neutral,0,ai_bhvr_hold,0,(109, 127.5),[], 100),
  ("village_67","Tebandra",  icon.village_a|pf_village, no_menu, pt.none, fac.neutral,0,ai_bhvr_hold,0,(65, 23),[], 100),
  ...
  ("village_74","Ayyike",  icon.village_a|pf_village, no_menu, pt.none, fac.neutral,0,ai_bhvr_hold,0,(49, 31),[], 15),
  ("village_75","Bhulaban",  icon.village_snow_a|pf_village, no_menu, pt.none, fac.neutral,0,ai_bhvr_hold,0,(110.2, 48.8),[], 10),
  ("village_76","Kedelke",  icon.village_a|pf_village, no_menu, pt.none, fac.neutral,0,ai_bhvr_hold,0,(91.5, -34.8),[], 35),
  ("village_77","Rizi",  icon.village_a|pf_village, no_menu, pt.none, fac.neutral,0,ai_bhvr_hold,0,(-64.8, 81.5),[], 160),
  ...
  ("village_84","Chelez",  icon.village_a|pf_village, no_menu, pt.none, fac.neutral,0,ai_bhvr_hold,0,(-45.6, -83),[], 15),
  ("village_85","Ismirala",  icon.village_snow_a|pf_village, no_menu, pt.none, fac.neutral,0,ai_bhvr_hold,0,(22.8, 71.7),[], 10),
  ("village_86","Slezkh",  icon.village_snow_a|pf_village, no_menu, pt.none, fac.neutral,0,ai_bhvr_hold,0,(60.5, 68.2),[], 35),
  ("village_87","Udiniad",  icon.village_a|pf_village, no_menu, pt.none, fac.neutral,0,ai_bhvr_hold,0,(52.3, 111.8),[], 160),
  ...
  ("village_94","Mazigh",  icon.village_c|pf_village, no_menu, pt.none, fac.neutral,0,ai_bhvr_hold,0,(75.4, -61.65),[], 15),
  ("village_95","Tamnuh",  icon.village_c|pf_village, no_menu, pt.none, fac.neutral,0,ai_bhvr_hold,0,(99, -90.5),[], 10),
  ("village_96","Habba",  icon.village_c|pf_village, no_menu, pt.none, fac.neutral,0,ai_bhvr_hold,0,(107, -75),[], 35),
  ("village_97","Sekhtem",  icon.village_c|pf_village, no_menu, pt.none, fac.neutral,0,ai_bhvr_hold,0,(82.3, -76.8),[], 160),
  ...
  ("village_104","Tazjunat",  icon.village_c|pf_village, no_menu, pt.none, fac.neutral,0,ai_bhvr_hold,0,(159, -58.5),[], 15),
  ("village_105","Aab",  icon.village_c|pf_village, no_menu, pt.none, fac.neutral,0,ai_bhvr_hold,0,(135, -88.5),[], 10),
  ("village_106","Hawaha",  icon.village_c|pf_village, no_menu, pt.none, fac.neutral,0,ai_bhvr_hold,0,(10.3, -91.0),[], 35),
  ("village_107","Unriya",  icon.village_c|pf_village, no_menu, pt.none, fac.neutral,0,ai_bhvr_hold,0,(156.6, -84),[], 160),
...
#  bridge_a
  ...
  ("forest_bandit_spawn_point"  ,"the forests",pf_disabled|pf_is_static, no_menu, pt.none, fac.outlaws,0,ai_bhvr_hold,0,(-35, 18),[(trp.looter,15,0)]),
  ("mountain_bandit_spawn_point","the highlands",pf_disabled|pf_is_static, no_menu, pt.none, fac.outlaws,0,ai_bhvr_hold,0,(-90, -26.8),[(trp.looter,15,0)]),
  ...
  ("robber_knight_spawn_point"  ,"kingdoms",pf_disabled|pf_is_static, no_menu, pt.none, fac.robber_knights,0,ai_bhvr_hold,0,(-35, 18),[(trp.looter,15,0)]),
  ("roving_knight_spawn_point"  ,"kingdoms",pf_disabled|pf_is_static, no_menu, pt.none, fac.commoners,0,ai_bhvr_hold,0,(-40, 25),[(trp.looter,15,0)]),
  ("landless_knight_spawn_point"  ,"kingdoms",pf_disabled|pf_is_static, no_menu, pt.none, fac.outlaws,0,ai_bhvr_hold,0,(-80, -15),[(trp.looter,15,0)]),
...
# Merc Camp Begin 
    ("merc_camp_geroia", "Geroian Camp",  icon.camp|pf_hide_defenders|pf_is_static|pf_always_visible|pf_label_medium, no_menu, pt.none, fac.neutral,0,ai_bhvr_hold,0,(-45.27, 49.45),[], 100),
    ("merc_camp_balion", "Balion Keep",  icon.castle_a|pf_hide_defenders|pf_is_static|pf_always_visible|pf_label_medium, no_menu, pt.none, fac.neutral,0,ai_bhvr_hold,0,(-132.4, -53.3),[], 100),
    ("merc_camp_jumne", "Jumne Bay",  icon.ship_on_land|pf_hide_defenders|pf_is_static|pf_always_visible|pf_label_medium, no_menu, pt.none, fac.neutral,0,ai_bhvr_hold,0,(-41.16, 117),[], 100),
    ("merc_camp_zendar", "Ruins of Zendar",  icon.village_burnt_a|pf_hide_defenders|pf_is_static|pf_always_visible|pf_label_medium, no_menu, pt.none, fac.neutral,0,ai_bhvr_hold,0,(18,60),[], 100),
    ("merc_camp_end"                 ,"{!}last_spawn_point",    pf_disabled|pf_is_static, no_menu, pt.none, fac.commoners,0,ai_bhvr_hold,0,(0., 0),[(trp.looter,15,0)]),
# Merc Camp End 
